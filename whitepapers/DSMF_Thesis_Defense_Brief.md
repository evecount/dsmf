...
```mermaid
gantt
    title The 20-Minute Defense Runway
    dateFormat  mm
    axisFormat %M
    section Presentation
    1. Core Premise & Problem (Slides 1-2)  :active, 0, 3m
    2. Mathematical Formalism (Slides 3-6)  : 3, 10m
    3. Empirical Ablation (Slide 7)         : 10, 13m
    4. Enterprise Impact & CLEV (Slide 8)   : 13, 16m
    5. Co-Authorship & Conclusion (Slides 9-10) : 16, 20m
```
